...
var isRootSchema = function isRootSchema(schema) {
  var id = (0, _getSchema.getSchemaId)(schema);
  return id && id.indexOf('#') !== 0;
};
exports.isRootSchema = isRootSchema;
var SchemaRootContext = _react["default"].createContext({
  id: undefined,
  schema: undefined
});
var SchemaRootProviderBase = function SchemaRootProviderBase() {
  ...
  }, [id, schema].concat(_toConsumableArray(Object.values(further))));
  return _react["default"].createElement(SchemaRootContext.Provider, {
    value: context
  }, children);
};
