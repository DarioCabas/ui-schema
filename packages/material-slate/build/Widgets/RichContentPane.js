...
exports.RichContentPane = void 0;
...
var _PaneWrapper = require("@ui-schema/material-slate/EditorWrapper/PaneWrapper");
...
var RichContentPaneBase = function RichContentPaneBase(props) {
  ...
  var classes = (0, _PaneWrapper.usePaneEditorStyles)({
    dense: dense,
    focused: focused
  });
  return _react["default"].createElement(_PaneWrapper.PaneWrapper, {
    storeKeys: storeKeys,
    schema: schema,
    dense: dense,
    focused: focused,
...
var RichContentPane = (0, _uiSchema.extractValue)((0, _uiSchema.memo)(RichContentPaneBase));
exports.RichContentPane = RichContentPane;